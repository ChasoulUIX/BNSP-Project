...
<head>
    ...
    <title>Reset Password — {{ config('app.name', 'Sistem Barang') }}</title>
    ...
    <div class="flex min-h-screen">
        ...
        <div class="hidden lg:flex lg:w-1/2 auth-gradient relative overflow-hidden items-center justify-center p-12">
            ...
            <div class="relative z-10 text-center text-white max-w-md">
                ...
                <h1 class="text-4xl font-bold mb-4 leading-tight">Atur Ulang<br/>Password</h1>
                <p class="text-lg text-white/80 leading-relaxed">Buat password baru yang kuat untuk mengamankan akun Anda. Pastikan password mudah diingat namun sulit ditebak.</p>
            </div>
        </div>
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 bg-gray-50/50">
            <div class="w-full max-w-md fade-in">
                ...
                <div class="mb-8">
                    ...
                    <p class="text-gray-500 mt-1">Masukkan password baru Anda di bawah ini</p>
                </div>
                ...
                <div class="mb-6 p-4 bg-emerald-50 border border-emerald-200 rounded-xl">
                    <div class="flex gap-3">
                        ...
                        <p class="text-sm text-emerald-800">OTP berhasil diverifikasi! Silakan masukkan password baru Anda.</p>
                    </div>
                </div>
